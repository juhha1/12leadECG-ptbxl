...
class Xception(nn.Module):
    ...
    """
    def __init__(self, num_classes=71, input_channel = 12):
        """ Constructor
        Args:
        ...
        self.conv1 = nn.Conv1d(input_channel, 32, 3,2, 0, bias=False)
...
def xception(num_classes=71, input_channel = 12, pretrained=None):
